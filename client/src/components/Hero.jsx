  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradientBackground.png)] bg-no-repeat bg-cover min-h-screen">
      <div className="text-center mb-6">
        <h1 className="text-3xl sm:5xl md:text-6xl 2xl:text-7xl font-bold mx-auto leading-[1.2]">
      ...
      <div className="flex-wrap flex justify-center gap-4 text-sm max-sm:text-xs">
        <button
          onClick={() => navigate("/ai")}
